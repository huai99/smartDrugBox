...
public class U_PharmacyDetails implements IDbData, Parcelable {
    private String id;
    ...
    private U_PharmacyDetails(Parcel in) {
        id = in.readString();
    ...
    public static final Parcelable.Creator<U_PharmacyDetails> CREATOR = new Parcelable.Creator<U_PharmacyDetails>() {
        @Override
        public U_PharmacyDetails createFromParcel(Parcel in) {
            return new U_PharmacyDetails(in);
        }

        @Override
        public U_PharmacyDetails[] newArray(int size) {
            return new U_PharmacyDetails[size];
        }
    };
